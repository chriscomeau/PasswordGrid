...
class Key{
    ...
    init(type: KeyType, keyValue: String? = nil, keyImage: String? = nil , width: CGFloat, height: CGFloat, parentView: UIView, tag: Int? = nil, gapSize: CGSize? = nil) {
        ...
        //self.button.titleLabel?.font = UIFont(name: "Menlo", size: 18)
        ...
        //reset offset
        self.button.titleEdgeInsets.top = 0
    }
    ...
    func addSubscript(subScript: String, isIPad: Bool){
        ...
        //offset
        self.button.titleEdgeInsets.top = 8

        self.button.subString = subScript
        
        //font
        keyLabel.font = UIFont(name: "Menlo", size: 18)
        ...
        keyLabel.widthAnchor.constraint(equalToConstant: keyLabel.font.pointSize*2).isActive = true
