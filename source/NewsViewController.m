...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if(USE_ANALYTICS == 1)
	{
		[[LocalyticsSession sharedLocalyticsSession] tagEvent:@"NewsView"];
        [FlurryAnalytics logEvent:@"NewsView"];
	}
...
- (void)webView:(UIWebView *)webViewIn didFailLoadWithError:(NSError *)error
{
    ...
    if(USE_ANALYTICS == 1)
	{
		[[LocalyticsSession sharedLocalyticsSession] tagEvent:@"NewsView: webview error"];
        [FlurryAnalytics logEvent:@"NewsView: webview error"];
	}
