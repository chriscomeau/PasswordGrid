...
- (void)viewDidLoad
{
    ...
    tempFont = [UIFont fontWithName:@"HelveticaNeue" size:13] ;
    ...
    //image = [QREncoder encode:@"http://itunes.apple.com/app/id359807331"];
    ...
    */
    ...
    //ad
    [buttonNoAds addTarget:self action:@selector(actionClose:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)updateBadge
{
    ...
    //[appDelegate updateNumAppsBadge];
    //[appDelegate hideNumAppsBadge];
...
{
    NSString *textToShare = @"Check out Password Grid for iOS!";
    NSURL *url = [NSURL URLWithString:@"http://itunes.apple.com/app/id359807331"];
    NSString *subject = @"Password Grid for iOS";
    ...
    if([Helpers isIpad])
    {
        ...
        //[actionSheetShare showFromRect:shareButton.bounds inView:shareButton animated:YES];
        [actionSheetShare showFromRect:[sender frame] inView:self.view animated:YES];
    }
    else
    {
        actionSheetShare.actionSheetStyle = UIActionSheetStyleBlackTranslucent;
...
- (void)actionRate:(id)sender
{
	...
	//[self sendEmailTo:@"mailto:" withSubject: @"Check out Password Grid for iPhone!" withBody:@"http://vasy.ca/passrate"];
	//[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://passwordgrid.com/share"]];
...
-(void)actionTwitter:(id)sender
{
    ...
    */
    ...
    {
            [appDelegate openURL:[NSURL URLWithString:@"http://twitter.com/PasswordGrid"]]; //web
    }
    else
    {
            //show sheet
            ...
            [actionSheetTwitter showFromTabBar:[[appDelegate tabBarController] tabBar]];
...
-(void)alertView:(UIAlertView *)alertView willDismissWithButtonIndex:    (NSInteger)buttonIndex 
{
    ...
    else if(buttonIndex==1)
    {
        ...
        else
        {
                ...
                //[self sendEmailTo:@"info@skyriser.com" withSubject: @"Password Grid iPhone Feedback" withBody:@""];
                [appDelegate sendEmailTo:@"info@skyriser.com" withSubject: @"Password Grid iOS Feedback" withBody:body withView:self];
        }
    }
...
- (void)actionQR:(id)sender
{
	...
	//[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://itunes.apple.com/app/id359807331"]];	
...
- (void)actionVersion:(id)sender
{
	...
	[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://passwordgrid.com/changelog.php"]];	
}
...
-(void) actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    if(actionSheet == actionSheetContact)
    {
        switch (buttonIndex)
        {
    ...
    {
        //SHKItem *item = nil;
        NSString *urlString = [NSString stringWithFormat:@"http://itunes.apple.com/app/id359807331"];
        ...
        switch (buttonIndex)
        {
            case 0:
                ...
                {
                    [appDelegate sendEmailTo:@"" withSubject: @"Password Grid for iOS" withBody:@"Check out this application:\n\nhttp://itunes.apple.com/app/id359807331" withView:self];
                }
                else
            ...
            case 1:
                ...
                {
                    NSString *descString = [NSString stringWithFormat:@"Check out this application: Password Grid for iOS: %@", urlString];
                ...
                //facebook
            {
                ...
                /*item = [SHKItem URL:[NSURL URLWithString:urlString] title:descString contentType:SHKURLContentTypeWebpage];
                 NSString *pictureURL = @"http://quoteaddict.com/images/screenshot1.jpg"; //screenshot
...
- (void)restoreRemoveAds
{
    ...
    [[passwordmatrixIAPHelper sharedInstance] restoreCompletedTransactions];
